...
data class Animal1(val name: String, val description: String, val breed: String, val imageResId: Int)

val animal1 = Animal1("Merlin", "The British Shorthair is the pedigreed version of the traditional British domestic cat, with a distinctively stocky body, thick coat, and broad face. " +
...
val animal2 = Animal1("Apollo", "The German Shepherd, also known in Britain as an Alsatian, is a German breed of working dog of medium to large size. " +
        ...
        "and according to the Fédération Cynologique Internationale had the second-highest number of annual registrations in 2013.", "German hepherd", R.drawable.german_shepherd)

val animal3 = Animal1("Jackson", "The Shamrock Macaw is a very popular pet bird with two very popular types of macaws as its parents. The Scarlet Macaw, " +
